import { PrismaClient, JobCardStatus } from '@prisma/client';
...
async function main() {
  ...
  // 1. ROHAN MEHTA (Completed / Delivered)
  ...
  // 2. AMIT PATEL (Active Job #1 - READY)
  ...
  // 3. POOJA SEN (Active Job #2 - IN_PROGRESS)
  ...
  // 4. SNEHA GUPTA (Active Job #3 - DRAFT / PENDING)
  ...
  // 5. VIKRAM MALHOTRA (Active Job #4 - IN_PROGRESS)
  ...
  // 6. KIRAN RAO (Active Job #5 - READY)
